...
public class Main extends JavaPlugin implements Listener {
	...
	public void loadConfiguration() {
		plugin.getConfig().addDefault("General.FirstStartup", true); 
		...
		plugin.getConfig().addDefault("Messages.Activated", "&aThis mob group can attack again now");
		plugin.getConfig().addDefault("Messages.Deactivated", "&cThis mob group can no longer attack");
		plugin.getConfig().addDefault("Messages.Winner", "&cThe winner is team {team}!!!");
		...
		plugin.getConfig().addDefault("MOTD.Full", "§4Ending");
		...
		plugin.getConfig().addDefault("Items.JoinItems.Vote.Lore",
				"&7Rightlick to open;&8Leftclick for informations");
		plugin.getConfig().addDefault("Items.JoinItems.Vote.Slot", 1);
		...
		plugin.getConfig().addDefault("Items.Leave.Material", "REDSTONE");
		plugin.getConfig().addDefault("Items.Leave.Amount", 1);
		plugin.getConfig().addDefault("Items.Leave.Byte", 0);
		plugin.getConfig().addDefault("Items.Leave.Glow", true);
		plugin.getConfig().addDefault("Items.Leave.Displayname", "&cLeave");
		plugin.getConfig().addDefault("Items.Leave.Lore",
				"&7Rightlick to use");
		plugin.getConfig().addDefault("Items.Leave.Slot", 8);
		...
		plugin.getConfig().addDefault("Items.DefaultItems.2.Lore",
				"&7Kill them with the force Luke");
		plugin.getConfig().addDefault("Items.DefaultItems.2.Slot", 1);
	...
	public void onEnable() {
		...
		if(!Main.getPlugin().getConfig().getBoolean("General.FirstStartup")){
	    ...
	    TeamsB.state.add("blue");
	    TeamsB.state.add("red");
	    TeamsB.state.add("green");
	    TeamsB.state.add("yellow");
	}
