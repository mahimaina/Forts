 ...
 * @author RadBuilder
 */
public class RandomPathfinding extends PathfinderGoal {
    ...
    public RandomPathfinding(EntityCreature entitycreature, double d0) {
    ...
    public void c() {
        ...
        this.b.getNavigation().a(vec3d.x, vec3d.y, vec3d.z, 2);
    }
